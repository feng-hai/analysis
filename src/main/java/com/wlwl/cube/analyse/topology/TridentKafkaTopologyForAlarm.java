...
import com.wlwl.cube.ananlyse.spout.TridentKafkaSpoutForAlarm;
 ...
 * </p>
 */
public class TridentKafkaTopologyForAlarm {
...
//		}
		...
		TridentKafkaSpoutForAlarm kafkaInstance = new TridentKafkaSpoutForAlarm(zkUrl, brokerUrl, "pairs_up");
		if (args.length == 1) {
...
//					kafkaInstance.buildProducerTopology(kafkaInstance.getProducerConfig()));
			...
			// submit the consumer topology.
			cluster.submitTopology("alarm", kafkaInstance.getConsumerConfig(),
