...
import com.wlwl.cube.ananlyse.spout.TridentKafkaSpoutForVehiceStatus;
 ...
 * </p>
 */
public class TridentKafkaTopologyForVehicleStatus {
...
//		}
		...
		if (args.length == 1) {
			...
			cluster.submitTopology("vehicleStatus", kafkaInstance.getConsumerConfig(),
